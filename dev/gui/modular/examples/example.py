...
class ExamplePanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.logger = wx.TextCtrl(
            self, size=(200, 300), style=wx.TE_MULTILINE | wx.TE_READONLY)
        ...
        self.editname = wx.TextCtrl(
            self, value="Enter here your name", size=(140, -1))
        ...
        self.edithear = wx.ComboBox(
            self, size=(95, -1), choices=self.sampleList, style=wx.CB_DROPDOWN)
        ...
        grid.Add(self.insure, pos=(4, 0), span=(
            1, 2), flag=wx.BOTTOM, border=5)
        ...
        rb = wx.RadioBox(self, label="What color would you like ?",
                         pos=(20, 210), choices=radioList,  majorDimension=3,
